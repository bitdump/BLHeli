...
; - Rev16.62 Addition of Dshot commands for beeps and temporary reverse direction (largely by brycedjohnson)
;           
;
;**** **** **** **** ****
...
EEPROM_FW_SUB_REVISION		EQU	62		; Sub revision of the firmware
