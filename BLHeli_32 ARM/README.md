...
BLHeli_32 Rev32.6.1 test code is published in the "BLHeli_32 Test code Rev32.6.1 hex files" directory  
...
- Added capability of Dshot2400 and improved accuracy of Proshot (added Jan 13)
- Some smaller fixes
